...
async function main() {
  ...
  try {
    ...
    console.info('Isolated test schema initialized with draft protection, staff invitations, login limits, MFA, revisioned workspaces, immutable submissions and customer contact history');
  } finally {
    await pool.end();
  }
}
