...
2. Faire examiner et appliquer sur cette **seule base dédiée** les migrations `db/001` à `db/015`, dans l'ordre, avec plan de sauvegarde chiffrée et preuve de restauration avant données réelles. Les migrations 010 à 015 couvrent les contacts audités, l'autorisation d'émission, le suivi fournisseur, la matérialisation locale confirmée, l'archive PDF immuable et les profils émetteur vérifiés/versionnés.
