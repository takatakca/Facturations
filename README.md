...
2. Faire examiner et appliquer sur cette **seule base dédiée** les migrations `db/001` à `db/012`, dans l'ordre, avec plan de sauvegarde chiffrée et preuve de restauration avant données réelles. Les migrations 010, 011 et 012 couvrent respectivement l'édition auditée des fiches clients, l'autorisation d'émission et l'état persistant d'une tentative fournisseur.
