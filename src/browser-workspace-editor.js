...
<div class="actions"><button id="save" class="primary" type="submit" disabled>${t.save}</button><button id="reload" type="button" disabled>${t.reload}</button><a id="preview" href="/internal/recent-workspaces?lang=${language}" hidden>${t.preview}</a></div>
