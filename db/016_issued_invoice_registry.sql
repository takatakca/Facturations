...
-- Materializes an immutable local issued-invoice record only from a provider execution
-- already CONFIRMED. This migration performs no network request and sends no email.
BEGIN;
