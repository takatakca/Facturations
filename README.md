...
2. Faire examiner et appliquer sur cette **seule base dédiée** les migrations `db/001` à `db/013`, dans l'ordre, avec plan de sauvegarde chiffrée et preuve de restauration avant données réelles. Les migrations 010 à 013 couvrent respectivement l'édition auditée des fiches clients, l'autorisation d'émission, le suivi idempotent des tentatives fournisseur et la matérialisation locale immuable d'un résultat confirmé.
