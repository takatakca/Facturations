...
2. Faire examiner et appliquer sur cette **seule base dédiée** les migrations `db/001` à `db/011`, dans l'ordre, avec plan de sauvegarde chiffrée et preuve de restauration avant données réelles. Les migrations 010, 011 et 012 sont requises respectivement pour l'édition auditée des fiches clients, l'autorisation d'émission en attente du fournisseur et l'état append-only des tentatives/résultats/réconciliations.
